...
namespace RyanQuagliataUnity.Extensions.DOTween {
	...
	public class TweenerSettings : ScriptableObject {
		...
		[PropertyOrder(10), HorizontalGroup("Ease", 50), LabelText("3±"), LabelWidth(25), Tooltip("When enabled the buttons will make the ease function step 3 items at a time")]
		private bool nextEaseStepLarge = false;
